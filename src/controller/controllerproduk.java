...
//                theView.settotal(total);
    ...
    private class updateListener implements ActionListener {
        ...
        @Override
        public void actionPerformed(ActionEvent e) {
         if (theView.getjumlah().toString().equalsIgnoreCase("")|| theView.getharga().toString().equalsIgnoreCase("")|| theView.getnama().toString().equalsIgnoreCase("")||theView.getmasuk().toString()
             .equalsIgnoreCase("")) 
