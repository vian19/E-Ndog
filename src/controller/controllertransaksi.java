...
//                theView.textbayar(true);
    ...
    private class selesai implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
            if (theView.getIdp().toString().equalsIgnoreCase("")|| theView.getbayar().toString().equalsIgnoreCase("")|| theView.gettotal().toString().equalsIgnoreCase("")) {
                theView.popUpPesan("Data Tidak Lengkap !");
            }
               else if (Integer.parseInt(theView.getkembalian()) >= 0) {
